...
-- Prettier --
keymap("n", "<S-A-f>", ":!npx prettier --loglevel silent --write %<Enter>", opts) 
...
-- Save & exit
keymap("n", "<C-s>", ":w!<Enter>", opts)
keymap("n", "<C-c>", ":bd<Enter>", opts)
keymap("n", "<C-q>", "<C-w><C-q>", opts)

keymap("i", "<C-s>", "<ESC>:w!<Enter>", opts)
keymap("i", "<C-c>", "<ESC>:bd<Enter>", opts)
keymap("i", "<C-q>", "<ESC><C-w><C-q>", opts)
